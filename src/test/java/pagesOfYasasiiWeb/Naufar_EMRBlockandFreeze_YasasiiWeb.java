...
public class Naufar_EMRBlockandFreeze_YasasiiWeb  extends PageFactoryInitYasasiiWeb {

	public Naufar_EMRBlockandFreeze_YasasiiWeb(WebDriver driver) {
		super(driver);
	} 
...
//		Thread.sleep(2000);
		...
		//AppSelect.click();
		Thread.sleep(800); //tr[@class='row-0-0 ng-star-inserted']//i[@class='ki ki-close']
		cLOSEiPApp.click();
		Thread.sleep(800);
		CancelReason.click();
		Thread.sleep(800);
