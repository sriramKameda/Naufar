...
public class Naufar_Appointment_master_blockAndfreeze_YasassiWeb extends PageFactoryInitYasasiiWeb {

	public Naufar_Appointment_master_blockAndfreeze_YasassiWeb(WebDriver driver) {
		super(driver);
	} 
	...
	@FindBy(xpath = "//div[@title='Sultan Essa I Albrahim(100435)']")
	...
	public void App() throws InterruptedException, AWTException{
		...
		Thread.sleep(500);
		Searchresource.sendKeys("Sultan Essa I Albrahim(100435)");
		Thread.sleep(2000);	
