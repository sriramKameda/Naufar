...
public class Naufar_AppointmentCheckin_Yasassiweb  extends PageFactoryInitYasasiiWeb {

	public Naufar_AppointmentCheckin_Yasassiweb(WebDriver driver) {
		super(driver);
	}
	...
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-billing-overview[1]/div[1]/div[2]/app-upcoming-appt[1]/div[1]/div[2]/div[1]/div[1]/div[1]/img[1]")
	...
	public void patreg(String title,String Name,String lastname,String Dob, String DocID, String MobNo,String Address,String MRNo) throws InterruptedException, AWTException, IOException {
		...
		Subcategory.click();
		Thread.sleep(500);
		driver.findElement(By.xpath("//li[normalize-space()='DCU']")).click();
		Thread.sleep(500);
	...
	public void Appointment(String Provider,String service ,String MRNo) throws AWTException, InterruptedException {
		...
		Thread.sleep(2000);
		///delete App
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-billing-overview[1]/div[1]/div[2]/app-upcoming-appt[1]/div[1]/div[2]/div[1]/label[1]/i[1]")).click();
		Thread.sleep(1000);
