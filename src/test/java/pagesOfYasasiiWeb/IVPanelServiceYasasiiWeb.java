...
public class IVPanelServiceYasasiiWeb extends PageFactoryInitYasasiiWeb{
	
	public IVPanelServiceYasasiiWeb(WebDriver driver) {
		super(driver);
...
//SampleProcessing
	...
	@FindBy(xpath="//input[@id='status']")
	public WebElement statussp;
///Filter
	@FindBy(xpath="//input[@id='searchtexttest']")
	public WebElement searchsevice;
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/button[3]")
...
///Result Entry
	...
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[2]/form[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/span[1]/span[1]/ki-input-control[1]/div[1]/input[1]")
	public WebElement result2;
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[2]/form[1]/div[4]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/span[1]/span[1]/ki-input-control[1]/div[1]/input[1]")
	public WebElement result3;
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[2]/form[1]/div[5]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/span[1]/span[1]/ki-input-control[1]/div[1]/input[1]")
	public WebElement result4;
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[2]/form[1]/div[6]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/span[1]/span[1]/ki-input-control[1]/div[1]/input[1]")
	public WebElement result5;
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[2]/form[1]/div[7]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/span[1]/span[1]/ki-input-control[1]/div[1]/input[1]")
	public WebElement result6;
...
///Result Authorization
	...
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[1]/lib-searchlab[1]/form[1]/div[3]/div[1]/div[1]/div[1]/div[1]/ki-select-control[1]/div[1]/input[1]")
...
//Filters
	...
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[4]/div[1]/span[1]/span[2]/i[1]")
	public WebElement cross;
	@FindBy(xpath="//i[@class=' ki ki-filter-list']")
	public WebElement Rangef;
	@FindBy(xpath="//span[3]//span[1]//i[1]")
	public WebElement Authorif;
	@FindBy(xpath="//i[@title='Category ']")
	public WebElement categoryf;
...
public void patientreg(String NAME , String AGE , String MBLNO , String ORGANISATION , String ADDRESS , String AADHAAR ) throws InterruptedException, IOException {
		...
		HSSFSheet FOFullRegTest=wb.getSheetAt(64);	
	...
	public void  pan(String MRNo,String MR,String panel,String r1,String r2,String r3,String r4,String r5,String r6) throws InterruptedException, IOException 
	{
...
/////CPOEService
			...
			cpoesearch.click();
			Thread.sleep(1000);
			cpoesearch.sendKeys("Lipid Panel");
			Thread.sleep(2500);
...
////////////////SampleProcessing
		  ...
		  accept.click();
		  Thread.sleep(3000);
//fliter by servicename
		  searchsevice.click();
		  Thread.sleep(2000);
		  searchsevice.sendKeys(panel);
		  Thread.sleep(2000);
		  searchsevice.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  clear.click();
		  Thread.sleep(2000);
///service-sampleProcessing
		  statussp.click();
		  Thread.sleep(2000);
...
//////Result Entry
		  ...
		  result1.sendKeys(r1);
		  Thread.sleep(2000);
		  result1.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  result2.click();
		  Thread.sleep(2000);
		  result2.sendKeys(r2);
		  Thread.sleep(2000);
		  result2.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  result3.click();
		  Thread.sleep(2000);
		  result3.sendKeys(r3);
		  Thread.sleep(2000);
		  result3.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  result4.click();
		  Thread.sleep(2000);
		  result4.sendKeys(r4);
		  Thread.sleep(2000);
		  result4.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  result5.click();
		  Thread.sleep(2000);
		  result5.sendKeys(r5);
		  Thread.sleep(2000);
		  result5.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  result6.click();
		  Thread.sleep(2000);
		  result6.sendKeys(r6);
		  Thread.sleep(2000);
		  result6.sendKeys(Keys.ENTER);
		  Thread.sleep(2000);
		  Saveresult.click();
		  Thread.sleep(4000);
////Result Authorization
...
//Filters
		  ...
		  cross1.click();
		  Thread.sleep(2000);
		  Authorif.click();//span[3]//span[1]//i[1]
		  Thread.sleep(2000);
