...
public class Naufar_BlockandFreeze_Yasassiweb extends PageFactoryInitYasasiiWeb {

	public Naufar_BlockandFreeze_Yasassiweb(WebDriver driver) {
		super(driver);
	} 
	...
	//	Thread.sleep(2000);
		...
		AppReason.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[normalize-space()='Clinical Scales']")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[normalize-space()='Clinician In Meeting']")).click();
		Thread.sleep(1000);
		...
		DeleteReason.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[normalize-space()='Clinician Sick']")).click();
		Thread.sleep(1000);
		cancelApp.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//button[normalize-space()='OK']")).click();
