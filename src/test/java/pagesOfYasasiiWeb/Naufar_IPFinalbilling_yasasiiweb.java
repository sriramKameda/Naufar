...
public class Naufar_IPFinalbilling_yasasiiweb extends PageFactoryInitYasasiiWeb{

	public Naufar_IPFinalbilling_yasasiiweb(WebDriver driver) {
	...
	public void doctoreNote(String docid,String docpassword,String Site,String MRNO ) throws InterruptedException {
		...
		category1.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[normalize-space()='Key Worker']")).click();
		Thread.sleep(1000);
		ChangeProvider.click();
		Thread.sleep(500);
		Provider.sendKeys("100413");
		Thread.sleep(500);
		driver.findElement(By.xpath("//li[normalize-space()='Mrs. Nadia Benaissa']")).click();
		Thread.sleep(500);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[normalize-space()='Patient Died']")).click();
		Thread.sleep(1000);
