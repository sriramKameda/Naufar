...
public class IVRedoRequestYasasiiWeb extends PageFactoryInitYasasiiWeb{
	
	public IVRedoRequestYasasiiWeb(WebDriver driver) {
		super(driver);
...
///Addendum flow
	   ...
	   @FindBy(xpath="/html[1]/body[1]/modal-container[1]/div[1]/div[1]/div[2]/form[1]/ki-textarea-control[1]/div[1]/textarea[1]")
	   public WebElement comment;
	   @FindBy(xpath="//button[@class='btn btn-dark-green inline active btn-sm m0']")
	   public WebElement ok;
	   @FindBy(xpath="//textarea[@id='unauthorizationremarks']")
	   public WebElement remarksun;
	   @FindBy(xpath="//button[@class='btn btn-dark-green inline active btn-sm m0']")
	   public WebElement unok;
	   ...
	   @FindBy(xpath="//input[@id='status']")
	   public WebElement statusad;
	   @FindBy(xpath="/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-resultentry[1]/div[1]/lib-searchlab[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]")
...
////resultchange
	   ...
	   public void  Redo(String MRNo,String MR,String reason,String remarks,String resultvalue,String add,String unauthorized,String newvalue) throws InterruptedException, IOException {
		 Thread.sleep(1000);
...
/////CPOEService
		    ...
		    driver.findElement(By.xpath("//div[@id='cpoeservicelist_2']//span[@class='ng-star-inserted'][normalize-space()='(Na)']")).click();
		    Thread.sleep(1000);
////Savenote		
		   savenote.click();	
		   Thread.sleep(3000);
...
////////Preview/Print
		  ...
		  close.click();
		  Thread.sleep(3000);
/////Addendum--Unauthorized 
		  addendum.click();
		  Thread.sleep(2000);
		  comment.click();
		  Thread.sleep(2000);
		  comment.sendKeys(add);
		  Thread.sleep(2000);
		  ok.click();
		  Thread.sleep(2000);
		  authorize.click();
		  ...
		  remarksun.click();
		  Thread.sleep(2000);
		  remarksun.sendKeys(unauthorized);
		  Thread.sleep(2000);
		  unok.click();
		  Thread.sleep(2000);
		  savead.click();
